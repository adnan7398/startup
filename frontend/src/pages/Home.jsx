    ...
    <div className="bg-white">
      ...
      <div className="relative bg-purple-600">
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-purple-600 mix-blend-multiply" />
        </div>
        <div className="relative max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
          ...
          <p className="mt-6 text-xl text-purple-100 max-w-3xl">
            Join a community of innovators, get access to resources, and turn your startup dreams into reality.
          </p>
          <div className="mt-10">
            <Link
              to="/signup"
          ...
          <div className="mt-10">
            <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-3 md:gap-x-8 md:gap-y-10">
              ...
              <div className="relative">
                ...
                <div className="ml-16">
                  <h3 className="text-lg leading-6 font-medium text-gray-900">Rapid Prototyping</h3>
                  <p className="mt-2 text-base text-gray-500">
                    Quickly validate your ideas with our prototyping tools and templates.
                  </p>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="ml-16">
                  ...
                  <p className="mt-2 text-base text-gray-500">
                    Connect with fellow entrepreneurs and get feedback on your ideas.
                  </p>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="ml-16">
                  ...
                  <p className="mt-2 text-base text-gray-500">
                    Your ideas and data are protected with enterprise-grade security.
                  </p>
                </div>
              </div>
            </div>
